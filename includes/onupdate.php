...
function xoops_module_update_uhqgeolocate(\XoopsModule $module, $oldversion = null)
{
    global $xoopsDB;
    ...
    // Load Language
    xoops_loadLanguage('admin', 'uhqgeolocate');
    ...
    if (file_exists($trustfile) && is_file($distfile)) {
        unlink($distfile);
    }
