<div id="help-template" class=outer>
    ...
    <h1 class="head">UHQ_GeoLocate Help</h1>
    ...
    <h4 class="even">API Key</h4>
    <p class="odd">This is your key/license which is required for you to access an external API provider.</p>
