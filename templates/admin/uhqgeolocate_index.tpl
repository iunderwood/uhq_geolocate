...
<p><{$smarty.const._AM_UHQGEO_QLV}> <{$data.v4db.querylib}></p>
<p><{$smarty.const._AM_UHQGEO_DBT}> <{$data.v4db.dbtype}></p>
<{if $data.v4db.dbdate}>
<p><{$smarty.const._AM_UHQGEO_DBD}> <{$data.v4db.dbdate}></p>
<{/if}>
<{if $data.v4db.dbsize}>
...
<p><{$smarty.const._AM_UHQGEO_QLV}> <{$data.v6db.querylib}></p>
<p><{$smarty.const._AM_UHQGEO_DBT}> <{$data.v6db.dbtype}></p>
<{if $data.v6db.dbdate}>
